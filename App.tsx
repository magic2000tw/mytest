    ...
    const menu = [
        {
            ...
            items: [
                { label: 'Dashboard Sales', icon: 'pi pi-fw pi-home', to: '/', badge: '', badgeClassName: 'p-badge-info' },
                { label: 'Dashboard Analytics', icon: 'pi pi-fw pi-home', to: '/favorites/dashboardanalytics', badge: '2', badgeClassName: 'p-badge-success' },
                { label: 'example', icon: 'pi pi-fw pi-home', to: '/components/example', badge: '', badgeClassName: 'p-badge-success' },
            ]
        }
    ];
    // const menu = [
            ...
            <div className={layoutContainerClassName} onClick={onDocumentClick}>
                ...
                <div className="layout-main">
                    ...
                    <div className="layout-content">
                        <Route path="/" exact render={() => <Dashboard colorMode={colorMode} location={location} isNewThemeLoaded={newThemeLoaded} onNewThemeChange={(e: any) => setNewThemeLoaded(e)} />} />
                        <Route path="/start/documentation" component={Documentation} />
                        <Route path="/favorites/dashboardanalytics" render={() => <DashboardAnalytics colorMode={colorMode} location={location} isNewThemeLoaded={newThemeLoaded} onNewThemeChange={(e: any) => setNewThemeLoaded(e)} />} />
                        ...
                        <Route path="/uikit/chart" render={() => <ChartDemo colorMode={colorMode} location={location} isNewThemeLoaded={newThemeLoaded} onNewThemeChange={(e: any) => setNewThemeLoaded(e)} />} />
